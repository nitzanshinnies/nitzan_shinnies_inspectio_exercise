...
WORKER_ACTIVATION_COALESCE_MAX_PENDING: int = max(
    1, int(os.environ.get("INSPECTIO_WORKER_ACTIVATION_COALESCE_MAX_PENDING", "4096"))
)
WORKER_ACTIVATION_COALESCE_WINDOW_MS: int = max(
    0, int(os.environ.get("INSPECTIO_WORKER_ACTIVATION_COALESCE_WINDOW_MS", "20"))
)
